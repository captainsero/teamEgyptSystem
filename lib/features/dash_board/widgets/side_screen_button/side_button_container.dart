        ...
        child: Column(
          ...
          children: [
            SideButton(
              ...
              isChanged: context.watch<CustomersDataCubit>().state.selectedPage == 1,
            ),
            ...
            SideButton(
              ...
              isChanged: context.watch<CustomersDataCubit>().state.selectedPage == 2,
            ),
            const SizedBox(height: 10),
            SideButton(
              label: "Partnerships",
              ...
              isChanged: context.watch<CustomersDataCubit>().state.selectedPage == 3,
            ),
            const SizedBox(height: 10),
            SideButton(
              label: "Subscriptions",
              ...
              isChanged: context.watch<CustomersDataCubit>().state.selectedPage == 4,
            ),
            const SizedBox(height: 10),
            SideButton(
              label: "Rooms",
              ...
              isChanged: context.watch<CustomersDataCubit>().state.selectedPage == 5,
            ),
            const SizedBox(height: 10),
            SideButton(
              label: "Stuff",
              ...
              isChanged: context.watch<CustomersDataCubit>().state.selectedPage == 6,
            ),
            const SizedBox(height: 10),
            SideButton(
              label: "Items",
              ...
              isChanged: context.watch<CustomersDataCubit>().state.selectedPage == 7,
            ),
          ],
        ),
      ),
