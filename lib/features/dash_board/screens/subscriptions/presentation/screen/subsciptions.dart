...
import 'package:team_egypt_v3/features/dash_board/screens/subscriptions/presentation/widget/add_subscription_plan.dart';
...
class _SubsciptionsState extends State<Subsciptions> {
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          Row(children: [AddSubscriptionPlan(), Spacer(), AddSubscription()]),
